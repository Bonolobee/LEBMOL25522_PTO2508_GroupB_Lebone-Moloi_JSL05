 ...
 * @param {Object} elements
 * @param {{
 *   getTaskById: (taskId: number) => ({ id: number, title: string, description: string, status: string } | null),
 *   onCreateTask: (taskInput: {title: string, description: string, status: string}) => void,
 *   onUpdateTask: (taskId: number, taskInput: {title: string, description: string, status: string}) => void,
